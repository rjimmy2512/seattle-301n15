...
const sumAndProduct = (a, b) => {return [a + b, a * b];};
...
const message = (name) => {return `Hello, ${name}!`;};
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));
...
// TODO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?
// "this" acts as an object reference when joe.scope() is invoked
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" acts as a undefined parameter when joe.scopeArrow() is invoked
// 3. Explain why "this" is different when an arrow function is used.
//  When an arrow function is used,"this" acts a global-scoped object.
>>>>>>> app.js for lab-00b
